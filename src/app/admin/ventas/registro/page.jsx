...
export default function Page({
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      const response = await postCreataVenta({ idCliente: cliente.idCliente, detalleVenta: listProducts, total, igv: total * 0.18 });
      console.log({ idCliente: cliente.idCliente, detalleVenta: listProducts, total, igv: total * 0.18 })
